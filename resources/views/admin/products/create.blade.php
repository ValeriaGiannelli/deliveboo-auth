    ...
    <form class="row g-3" action="{{route('admin.products.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-12">
            ...
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="visible" name="visible" class="custom-control-input" value="true">
                <label class="custom-control-label" for="visible">Sì</label>
            </div>

            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="not_visible" name="visible" class="custom-control-input" value="false">
